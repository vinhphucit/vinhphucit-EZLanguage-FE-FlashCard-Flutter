...
class AuthApiService extends BaseApiService {
  ...
  final String _confirmResetPaswordCodeEndpoint = 'auth/confirmResetPassword';
  final String _verifyEmail = 'auth/verifyEmail';
  ...
  Future<void> requestResetPassword(String email) async {
    return await post(
        '$_baseUrl$_requestResetPaswordEndpoint', {'email': email});
  }

  Future<void> confirmResetPasswordCode(
      String email, String code, String newPassword) async {
    return await post('$_baseUrl$_confirmResetPaswordCodeEndpoint', {
      'email': email,
      'token': code,
  ...
  Future<void> activateAccountByCode(String email, String code) async {
    return await post('$_baseUrl$_verifyEmail', {
      'email': email,
      'code': code,
    });
  }
